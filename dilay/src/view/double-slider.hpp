...
class ViewDoubleSlider : public QSlider
{
  Q_OBJECT
public:
	ViewDoubleSlider (unsigned short, unsigned short); ViewDoubleSlider (const ViewDoubleSlider&) = delete; ViewDoubleSlider (ViewDoubleSlider&&) = delete; const ViewDoubleSlider& operator= (const ViewDoubleSlider&) = delete; const ViewDoubleSlider& operator= (ViewDoubleSlider&&) = delete; ~ViewDoubleSlider ( );
